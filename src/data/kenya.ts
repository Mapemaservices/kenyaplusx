export const KENYA_COUNTIES_CONSTITUENCIES: Record<string, string[]> = {
  "Mombasa": ["Changamwe", "Jomvu", "Kisauni", "Nyali", "Likoni", "Mvita"],
  "Kwale": ["Msambweni", "Lungamawe", "Matuga", "Kinango"],
  "Kilifi": ["Kilifi North", "Kilifi South", "Kaloleni", "Rabai", "Ganze", "Malindi", "Magarini", "Chonyi"],
  ...
  "Mandera": ["Mandera North", "Banissa", "Mandera West", "Mandera South", "Mandera East", "Lafey"],
  ...
  "Machakos": ["Masinga", "Yatta", "Kangundo", "Kathiani", "Mavoko", "Machakos Town", "Mwala", "Matungulu"],
  "Makueni": ["Mbooni", "Kilome", "Kaiti", "Makueni", "Kibwezi West", "Kibwezi East"],
  "Nyandarua": ["Kinangop", "Kipipiri", "Ol Kalou", "Ndaragwa", "Ol Jorok"],
  "Nyeri": ["Tetu", "Kieni", "Mathira", "Othaya", "Mukurweini", "Nyeri Town"],
  "Kirinyaga": ["Mwea", "Gichugu", "Ndia", "Kirinyaga Central", "Mwea"],
  ...
  "Nakuru": ["Molo", "Njoro", "Mau Narok", "Kuresoi South", "Kuresoi North", "Subukia", "Rongai", "Bahati", "Nakuru Town West", "Nakuru Town East", "Naivasha"],
...
export const KENYA_COUNTIES = Object.keys(KENYA_COUNTIES_CONSTITUENCIES).sort()
...
export const AGE_GROUPS = ["18–25", "26–35", "36–45", "46–55", "56–65", "66+"]

export const GENDERS = ["Male", "Female", "Prefer not to say"]

export const BIGGEST_ISSUES = [
...
export const SEAT_COLORS: Record<string, string> = {
  ...
  "Woman Representative": "bg-pink-100 text-pink-700",
  "Member of Parliament (MP)": "bg-amber-100 text-amber-700",
  "Member of County Assembly (MCA)": "bg-teal-100 text-teal-700",
}
